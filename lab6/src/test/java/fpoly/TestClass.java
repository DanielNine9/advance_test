...
public class TestClass {
	...
	public void unitLevel1() {
		System.out.println("testClass: Unit levell testing");
	}
	...
	@Parameters({ "param" })
	@BeforeMethod
	public void beforeMethodWithParam( @Optional("default value") String param) {
		System.out.println("testClass: before method with param " + param );
	}
